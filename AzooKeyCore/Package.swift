...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/azooKey/AzooKeyKanaKanjiConverter", revision: "fb11f1da84af322adec8a1b45888dc4a6d87e328", traits: ["ZenzaiCPU"]),
        .package(url: "https://github.com/azooKey/CustardKit", revision: "52afc537a3ccb49adca58fe14800ffb23eb86450"),
    ],
    targets: [
        .target(
            name: "SwiftUIUtils",
